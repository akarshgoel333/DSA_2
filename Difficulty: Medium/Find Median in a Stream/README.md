<h2><a href="https://www.geeksforgeeks.org/problems/find-median-in-a-stream-1587115620/1?page=1&difficulty%5B%5D=2&category%5B%5D=Heap&sortBy=submissions">Find Median in a Stream</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 14pt;">Given a data stream&nbsp;<strong>arr[]</strong> where integers are read sequentially, find the <strong>median </strong>of the elements encountered so far after each new integer is read.</span></p>
